...
if (isset($_POST["Submit"])) {
    ...
    if (empty($Dato)) {
        ...
        global $ConnectingDB;
        $sql = "INSERT INTO presen3(dato,tid, rom,author,date) 
...
<meta charset="utf-8">
<title> Final presentasjon</title>
</head>
...
<body>
    ...
    <nav class="navbar navbar-expand-lg navbar-dark">
        <ul class="navbar-nav ">
            ...
            <li class="nav-item">
                <a class="nav-link active" href="presentation3.php">Siste presentasjon</a>
            </li>
        </ul>
    ...
    <section class="container py-2 mb-4">
        <div class="row">
            <div class="offset-lg-1 col-lg-10">
                ...
                <form action="presentation3.php" method="post" enctype="multipart/form-data">

                    <div class="card mb-3">
                        <h4 class="text-center ">Fyll inn dato for 3. presentasjon</h4>
                        <div class="card-body">
