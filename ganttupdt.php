        ...
        <div class="row">
            <div class="offset-sm-2 col-sm-8">
                <form action="gantt.php" method="post" enctype="multipart/form-data">
                    ...
                    <div class="card mb-3">
                        <h4 class="text-center ">Oppdater Gantt Diagram</h4>
                        <?php
                        $sql = "SELECT * FROM gantt WHERE id = ? ORDER BY desc";
                        $stmt = mysqli_query($ConnectingDB, $sql);
                        while ($dataRows = mysqli_fetch_row($stmt)) {
                            $Id  = $dataRows['id'];
                            $Name = $dataRows['name'];
                            $sprint = $dataRows['sprint'];
                            $Syy = $dataRows['syy'];
                            $Smm = $dataRows['smm'];
                            $Sdd = $dataRows['sdd'];
                            $Eyy = $dataRows['eyy'];
